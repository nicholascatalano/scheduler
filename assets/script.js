...
$(function () {
  ...
  $(".saveBtn").on("click", function () {
    // variable to store the id of the specific parent you target (this) using its id (hour)
    var parentId = $(this).parent().attr("id");
    console.log(parentId);
    // variable to store the id of the specific child you target (this) using the description class
